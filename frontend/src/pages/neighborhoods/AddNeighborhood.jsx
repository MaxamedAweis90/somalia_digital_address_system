...
export default function AddNeighborhood() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setServerError(error.response?.data?.message || "Failed to create neighborhood");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-bg font-sans">
      <div className="px-4 sm:px-6 lg:px-5 pt-5 pb-10">
        ...
        <div className="flex items-center gap-2 text-[11px] font-medium text-ink-soft mb-6">
          ...
          <span className="text-gray-400">›</span>
          <span className="text-ink font-semibold">Add Neighborhood</span>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-[13px] text-ink-soft">
            Register a new neighborhood under an administrative district.
          </p>
        </div>
        ...
        <div className="w-full max-w-[635px] bg-white border border-line rounded-xl shadow-card-sm overflow-hidden">
          <div className="px-5 py-5 border-b border-line">
            ...
            <p className="mt-1 text-[13px] text-ink-soft">
              Enter official details for the new neighborhood.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-end gap-3 px-5 py-4 bg-[#FBFBFC] border-t border-line">
              ...
              <button
                ...
                "
              >
                {loading ? "Creating..." : "Add Neighborhood"}
              </button>
            </div>
          </form>
        </div>
