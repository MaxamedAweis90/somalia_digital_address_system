  ...
  return (
    <div className="flex h-screen w-full bg-bg font-sans text-ink overflow-hidden">
      ...
      >
        ...
        >
          <div className={`flex min-w-0 items-center ${collapsed ? "flex-col gap-3" : "flex-1 gap-3"}`}>
            ...
            {!collapsed && (
              <div className="min-w-0 flex-1 overflow-hidden">
                <p className="truncate text-base font-semibold leading-tight text-white font-display">SDAS</p>
                <p className="truncate text-[11px] leading-tight text-slate-300 font-medium">Field Collection</p>
              </div>
            )}
          </div>
          <button
      ...
      <div className="flex min-w-0 flex-1 flex-col h-full overflow-hidden">
        <AppTopBar searchQuery={searchQuery} onSearchChange={setSearchQuery} roleLabel="DATA_COLLECTOR" user={user} />
