...
export const createDataCollector = async (req, res) => {
  try {
    const collector = await DataCollectorService.createCollectorAsAdmin(req.body);
...
export const getDataCollectorById = async (req, res) => {
  try {
    const collector = await DataCollectorService.getCollectorByIdAsAdmin(req.params.id);
...
export const updateDataCollector = async (req, res) => {
  try {
    const collector = await DataCollectorService.updateCollectorAsAdmin(
      req.params.id,
      req.body
    );
...
export const deleteDataCollector = async (req, res) => {
  try {
    const result = await DataCollectorService.deleteCollectorAsAdmin(req.params.id);
...
export const regenerateDataCollectorPassword = async (req, res) => {
  try {
    const result = await DataCollectorService.regeneratePasswordAsAdmin(req.params.id);
